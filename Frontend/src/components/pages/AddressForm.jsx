            ...
            <div className="w-full max-w-7xl ">
                ...
                <div className="grid grid-cols-1 mr-22  md:grid-cols-2 gap-6">
                    ...
                    <div className=" bg-white border-4 border-black rounded-2xl
                     p-4 sm:p-6 shadow-[6px_6px_0px_black] space-y-4 w-full ">
                        ...
                        {showForm ? (
                            ...
                            <>
                                ...
                                <div className="max-h-64 sm:max-h-72 overflow-y-auto space-y-3 pr-1">
                                    ...
                                    {addresses.map((addr, index) => {
                                        ...
                                        return (
                                            <div
                                                key={index}
                                                className={`p-4 rounded-xl border-2 border-black transition w-full
                                            ${isSelected
                                ...
                                <button className="w-full border-2 border-black py-3 rounded-lg bg-black text-white hover:bg-[#F59A3D] hover:text-black transition">
                                    Proceed to Checkout
                                </button>
                            </>
                        )}
                    ...
                    <div className="w-full h-full ml-22">
                        ...
                        <div className="w-full h-full bg-white border-4 border-black rounded-2xl p-4
                         sm:p-6 shadow-[6px_6px_0px_black] flex flex-col justify-between">
